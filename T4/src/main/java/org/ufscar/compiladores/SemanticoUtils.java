...
public class SemanticoUtils {
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.ExpressaoContext ctx) {
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.TermoLogicoContext ctx) {
        TabelaDeSimbolos.TipoLA ret = null;
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.FatorLogicoContext ctx) {
        return verificarTipo(escopos, ctx.parcelaLogica());
    }

    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.ParcelaLogicaContext ctx) {
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.ExpRelacionalContext ctx) {
        TabelaDeSimbolos.TipoLA ret = null;
        if (ctx.OP_REL() != null) {
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.ExpAritmeticaContext ctx) {
        TabelaDeSimbolos.TipoLA ret = null;
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.TermoContext ctx) {
        TabelaDeSimbolos.TipoLA ret = null;
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.FatorContext ctx) {
        TabelaDeSimbolos.TipoLA ret = null;
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.ParcelaContext ctx) {
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.ParcelaUnitariaContext ctx) {
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.ParcelaNaoUnitariaContext ctx) {
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(Escopos escopos, GrammarT4Parser.IdentificadorContext ctx) {
