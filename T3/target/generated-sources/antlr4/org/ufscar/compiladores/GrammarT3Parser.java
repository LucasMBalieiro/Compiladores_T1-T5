...
public class GrammarT3Parser extends Parser {
	...
	public static final int
		...
		T__45=46, OP_ARIT1=47, OP_ARIT2=48, OP_ARIT3=49, OP_REL=50, OP_BOOL_OU=51, 
		OP_BOOL_E=52, IDENT=53, NUMINT=54, NUMREAL=55, CADEIA=56, COMENTARIO=57, 
		WS=58, CADEIANAOFECHADA=59, COMENTARIONAOFECHADO=60, ERRO=61;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'tipo'", "'procedimento'", "'('", "')'", "'fim_procedimento'", "'funcao'", 
			"'fim_funcao'", "','", "'.'", "'['", "']'", "'literal'", "'inteiro'", 
			"'real'", "'logico'", "'^'", "'verdadeiro'", "'falso'", "'registro'", 
			"'fim_registro'", "'var'", "'leia'", "'escreva'", "'se'", "'entao'", 
			"'senao'", "'fim_se'", "'caso'", "'seja'", "'fim_caso'", "'para'", "'<-'", 
			"'ate'", "'faca'", "'fim_para'", "'enquanto'", "'fim_enquanto'", "'retorne'", 
			"'..'", "'&'", "'nao'", null, null, "'%'", null, "'ou'", "'e'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, "OP_ARIT1", 
			"OP_ARIT2", "OP_ARIT3", "OP_REL", "OP_BOOL_OU", "OP_BOOL_E", "IDENT", 
			"NUMINT", "NUMREAL", "CADEIA", "COMENTARIO", "WS", "CADEIANAOFECHADA", 
	...
	public final DeclaracoesContext declaracoes() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2264L) != 0)) {
				{
				setState(72);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final ValorConstanteContext valorConstante() throws RecognitionException {
		...
		try {
			...
			setState(161);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 126100789578956800L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final CorpoContext corpo() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 9018822377865216L) != 0)) {
				{
				{
				setState(200);
				comando();
	...
	public final ComandoContext comando() throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 135354279440417024L) != 0)) {
					{
					setState(320);
					expressao();
					setState(325);
	...
	public static class ParidadeContext extends ParserRuleContext {
		public TerminalNode OP_ARIT1() { return getToken(GrammarT3Parser.OP_ARIT1, 0); }
